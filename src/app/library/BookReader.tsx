...
export default function BookReader({ title, content }: BookReaderProps) {
  ...
  const increaseFontSize = () => {
    setFontSizeIndex(prev => Math.min(prev + 1, Object.keys(fontSizes).length - 1));
  };
  ...
  return (
    <div className="relative">
        ...
        <div className="flex justify-between items-center pt-4 mt-4 border-t-2 border-gray-500/50 shrink-0">
            ...
            <button onClick={increaseFontSize} disabled={fontSizeIndex === Object.keys(fontSizes).length - 1} className="text-2xl font-bold text-black/50 hover:text-black disabled:opacity-20 transition-colors">A+</button>
            </div>
