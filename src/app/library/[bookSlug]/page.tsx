...
export default async function BookPage({ params }: PageProps) {
  ...
  return (
    <main className="relative min-h-screen w-full bg-black bg-cover bg-center" style={{ backgroundImage: "url('/images/grand-hall-bg.png')" }}>
      ...
      {/* NEW: Return to Grand Hall Link */}
      <Link 
        href="/hall" 
        className="fixed top-4 right-4 z-50 text-gray-300 hover:text-amber-300 transition-colors duration-300 text-lg"
        style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.7)' }}
      >
