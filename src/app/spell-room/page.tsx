    ...
    >
      ...
      <header className="relative z-20 w-full p-6">
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center gap-4 md:flex-row md:justify-between">
            {/* Invisible spacer for desktop to balance the rooms button */}
            <div className="hidden md:block w-36 shrink-0" aria-hidden="true" />
            
            {/* Title Image - first on mobile, centered on desktop */}
            <div 
              className="relative w-full mx-auto aspect-5/1 h-[8vh] md:h-[12vh]"
              style={{ 
