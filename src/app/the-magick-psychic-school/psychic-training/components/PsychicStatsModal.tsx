    ...
    return (
      <div className={className}>
        <button 
          ...
          className="group relative bg-slate-900/90 backdrop-blur-md border border-white/10 rounded-xl p-1.5 shadow-2xl hover:border-indigo-500/50 transition-all flex items-center gap-1.5 md:gap-4 text-left w-auto md:w-64 max-w-[240px] md:max-w-none"
        >
