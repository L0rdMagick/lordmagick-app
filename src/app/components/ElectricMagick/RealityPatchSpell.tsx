    ...
    if (isHolding) {
      interval = setInterval(() => {
        if (stage === 'consecrate') {
            ...
            setProgress(prev => {
                ...
                if (next >= 100) {
                    ...
                    if (typeof nav !== 'undefined' && nav.vibrate) nav.vibrate([50, 50]);
                    return 100;
                }
                return next;
            });
        ...
        if (typeof nav !== 'undefined' && nav.vibrate) {
            if (stage === 'consecrate') nav.vibrate(5);
            else {
                if (Math.random() < (voidProgress / 100)) nav.vibrate(10);
            }
        }
      }, 20);
