...
import { 
  Activity, X, Zap, Brain, Network, Lock, Unlock
} from 'lucide-react';
...
const NeuralLinkSpell = ({ onExit }: { onExit: () => void }) => {
    ...
    // --- STAGE 2: SYNCHRONIZATION (Dual Touch) ---
    const SyncStage = () => {
        ...
        const checkTouches = (e: React.TouchEvent | React.MouseEvent) => {
            ...
            // To make it work on desktop for testing, we allow single click to charge slowly,
            // but on mobile we ideally want 2 fingers.
            // Let's simplify: Require holding the button(s).
    ...
    // --- STAGE 3: TRANSMISSION (The AI Result) ---
    const TransmitStage = () => {
