...
const StepContainer: React.FC<StepContainerProps> = ({ stageTitle, instruction, children, button, allowOverflow = false }) => (
    <div className="w-full h-full flex flex-col items-center justify-center gap-1 overflow-hidden">
        <div className="shrink-0 flex flex-col items-center justify-center text-center px-4 min-h-[4rem] md:min-h-0 h-auto py-2 md:py-0 md:pt-2 z-20 relative">
...
const Step0_Crossroads: React.FC<{ onSelectPath: (path: RitualPath) => void }> = ({ onSelectPath }) => (
    <div className="relative w-full h-full flex flex-col items-center justify-center">
        <div className="relative z-10 flex flex-row items-center justify-center gap-4 md:gap-16 h-full p-4 w-full max-w-4xl mx-auto">
            <button onClick={() => onSelectPath('hoodoo')} className="relative w-[45%] h-auto max-h-[80vh] aspect-[40/56] transition-transform duration-300 hover:scale-105 active:scale-95 shadow-xl rounded-lg overflow-hidden border border-amber-900/30 md:scale-80">
            ...
            <button onClick={() => onSelectPath('voodoo')} className="relative w-[45%] h-auto max-h-[80vh] aspect-[40/56] transition-transform duration-300 hover:scale-105 active:scale-95 shadow-xl rounded-lg overflow-hidden border border-amber-900/30 md:scale-80">
