...
const Stage: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => (
    <motion.div
        ...
        // THE FIX: This is the primary layout fix. It spaces direct children to the top and bottom.
                ...
                <div key={ritualStep} className="relative w-full h-full">
                    {ritualStep === 0 && (
                        <Stage className="gap-4 justify-center">
                            {/* THE FIX: The content area grows and centers its child */}
                            <div className="w-full grow min-h-0 flex items-center justify-center">
                                {/* THE FIX: Aspect-ratio container creates a stable canvas */}
