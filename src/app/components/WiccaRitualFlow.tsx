                ...
                <div key={ritualStep} className="relative w-full h-full">
                    ...
                    {ritualStep === 5 && generatedSpell && (
                         <Stage className="gap-4">
                            ...
                            <div className="w-full grow min-h-0 flex items-center justify-center">
                                <div className="relative w-full max-w-lg max-h-full">
                                    <Image src={`${ASSET_PATH}/wicca_charge_ingredient_template.png`} alt="Charge Ingredient" width={500} height={625} className="w-full h-full object-contain" />
                    ...
                    {ritualStep === 6 && generatedSpell && (
                        <Stage className="gap-4">
                             ...
                             <div className="w-full grow min-h-0 flex items-center justify-center">
                                <div className="relative w-full max-w-lg max-h-full">
                                    <Image src={`${ASSET_PATH}/wicca_incantation_scroll.png`} alt="Incantation" width={500} height={625} className="w-full h-full object-contain" />
                         ...
                         <Stage className="gap-4">
                            ...
                            <div className="w-full grow min-h-0 flex items-center justify-center">
                                <div className="relative w-full max-w-2xl max-h-full">
                                    <Image src={`${ASSET_PATH}/wicca_spell_manifestation.png`} alt="Spell Manifestation" width={800} height={800} className="w-full h-full object-contain" />
