                ...
                <div key={ritualStep} className="relative w-full h-full">
                    {ritualStep === 0 && (
                        <Stage className="gap-4">
                            {/* THE FIX: Main content area is constrained by max-h to prevent overflow */}
                    ...
                    {ritualStep === 7 && (
                        <Stage className="gap-4">
                            <StageTitle>Unleash the Magick</StageTitle>
                             {/* THE FIX: Main content area is constrained by max-h to prevent overflow */}
                            <div className="w-full max-h-[70vh] flex items-center justify-center">
                               <div onMouseDown={handleCastHold} onMouseUp={handleCastRelease} onMouseLeave={handleCastRelease} onTouchStart={handleCastHold} onTouchEnd={handleCastRelease} className="relative w-full max-w-2xl aspect-square max-h-full cursor-pointer flex items-center justify-center">
